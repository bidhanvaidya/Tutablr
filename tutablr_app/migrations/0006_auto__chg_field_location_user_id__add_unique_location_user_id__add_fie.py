...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.user_id'
        db.alter_column('tutablr_app_location', 'user_id_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Location', fields ['user_id']
        db.create_unique('tutablr_app_location', ['user_id_id'])

        # Adding field 'Booking.session_id'
        db.add_column('tutablr_app_booking', 'session_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tutablr_app.SessionTime'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Booking.creator_id'
        db.add_column('tutablr_app_booking', 'creator_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='creator_id+', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['user_id']
        db.delete_unique('tutablr_app_location', ['user_id_id'])


        # Changing field 'Location.user_id'
        db.alter_column('tutablr_app_location', 'user_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'Booking.session_id'
        db.delete_column('tutablr_app_booking', 'session_id_id')

        # Deleting field 'Booking.creator_id'
        db.delete_column('tutablr_app_booking', 'creator_id_id')
    ...
    models = {
        ...
        'tutablr_app.booking': {
            ...
            'creator_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_id+'", 'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '56'}),
            ...
            'session_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tutablr_app.SessionTime']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        'tutablr_app.userprofile': {
            ...
            'about_me': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '400'}),
            'extra_details': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '400'}),
            'home_phone': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_student_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 20, 0, 0)'}),
            'mobile_phone': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '11'}),
