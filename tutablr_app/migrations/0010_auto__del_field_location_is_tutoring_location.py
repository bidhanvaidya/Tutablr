...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.is_tutoring_location'
        db.delete_column('tutablr_app_location', 'is_tutoring_location')


    def backwards(self, orm):
        # Adding field 'Location.is_tutoring_location'
        db.add_column('tutablr_app_location', 'is_tutoring_location',
