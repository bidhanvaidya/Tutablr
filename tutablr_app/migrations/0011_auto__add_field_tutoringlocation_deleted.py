...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TutoringLocation.deleted'
        db.add_column('tutablr_app_tutoringlocation', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TutoringLocation.deleted'
        db.delete_column('tutablr_app_tutoringlocation', 'deleted')
