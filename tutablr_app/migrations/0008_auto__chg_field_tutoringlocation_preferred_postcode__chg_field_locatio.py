...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TutoringLocation.preferred_postcode'
        db.alter_column('tutablr_app_tutoringlocation', 'preferred_postcode', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True))

        # Changing field 'Location.preferred_postcode'
        db.alter_column('tutablr_app_location', 'preferred_postcode', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'TutoringLocation.preferred_postcode'
        db.alter_column('tutablr_app_tutoringlocation', 'preferred_postcode', self.gf('django.db.models.fields.IntegerField')(default=2000, max_length=4))

        # Changing field 'Location.preferred_postcode'
        db.alter_column('tutablr_app_location', 'preferred_postcode', self.gf('django.db.models.fields.IntegerField')(default=2000, max_length=4))
    ...
    models = {
        ...
        'tutablr_app.location': {
            ...
            'preferred_postcode': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True'}),
        ...
        'tutablr_app.tutoringlocation': {
            'Meta': {'object_name': 'TutoringLocation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {}),
            'longitude': ('django.db.models.fields.FloatField', [], {}),
            'preferred_postcode': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True'}),
        ...
        'tutablr_app.userprofile': {
            ...
            'is_student_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 24, 0, 0)'}),
