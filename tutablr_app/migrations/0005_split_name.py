...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.description'
        db.add_column('tutablr_app_booking', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=56),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Booking.description'
        db.delete_column('tutablr_app_booking', 'description')
    ...
    models = {
        ...
        'tutablr_app.userprofile': {
            ...
            'is_student_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'}),
