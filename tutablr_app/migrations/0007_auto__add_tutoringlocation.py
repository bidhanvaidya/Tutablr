...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TutoringLocation'
        db.create_table('tutablr_app_tutoringlocation', (
        ...
        db.send_create_signal('tutablr_app', ['TutoringLocation'])


    def backwards(self, orm):
        # Deleting model 'TutoringLocation'
        db.delete_table('tutablr_app_tutoringlocation')
