...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TutoringLocation.preferred_postcode'
        db.delete_column('tutablr_app_tutoringlocation', 'preferred_postcode')

        # Deleting field 'Location.preferred_postcode'
        db.delete_column('tutablr_app_location', 'preferred_postcode')


    def backwards(self, orm):
        # Adding field 'TutoringLocation.preferred_postcode'
        db.add_column('tutablr_app_tutoringlocation', 'preferred_postcode',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)

        # Adding field 'Location.preferred_postcode'
        db.add_column('tutablr_app_location', 'preferred_postcode',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)
